...
- Detects Windows CPU/RAM/disk/GPU information with vendor tools and CIM/WMI fallback.
- Fetches Hugging Face model metadata, caches it under `%LocalAppData%\whichllm-gui\cache`, and supports `HF_ENDPOINT`.
