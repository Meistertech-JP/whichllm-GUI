...
Namespace Services
    Public Class GpuCatalog
        ...
        Private Shared ReadOnly Entries As List(Of GpuCatalogEntry) = New List(Of GpuCatalogEntry) From {
            ...
            Entry("Radeon Pro VII", "AMD", 16, 1024, "", False, "AMD Radeon Pro VII", "Vega 20 Pro"),
            Entry("Radeon Instinct MI60", "AMD", 32, 1024, "", False, "AMD Radeon Instinct MI60", "MI60", "Vega 20 MI60"),
            Entry("Radeon Instinct MI50", "AMD", 16, 1024, "", False, "AMD Radeon Instinct MI50", "MI50", "Vega 20 MI50"),
            Entry("RX Vega 64", "AMD", 8, 484, "", False, "Radeon RX Vega 64", "AMD Radeon RX Vega 64", "Vega 64"),
            Entry("RX Vega 56", "AMD", 8, 410, "", False, "Radeon RX Vega 56", "AMD Radeon RX Vega 56", "Vega 56"),
